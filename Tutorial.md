...
Selecciona todos los datos (Ctrl+A o Ctrl+E); copiálos (Ctrli no lo hace guardar en txt y luego abrir excel y dar clic en datos y después “Desde un archivo de texto”
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyNjcyODYyNSwtNjU0OTg5ODExLDE4MD
