...
<p><span class="katex--display"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math><semantics><mrow><mi>t</mi><mi>f</mi><mo>−</mo><mi>i</mi><mi>d</mi><msub><mi>f</mi><mrow><mi>t</mi><mo separator="true">,</mo><mi>d</mi></mrow></msub><mo>=</mo><mo>(</mo><mfrac><mrow><mi>t</mi><msub><mi>f</mi><mrow><mi>t</mi><mo separator="true">,</mo><mi>d</mi></mrow></msub></mrow><mrow><mi>N</mi></mrow></mfrac><mo>)</mo><mo>⋅</mo><msub><mi>log</mi><mo>⁡</mo><mrow><mn>1</mn><mn>0</mn></mrow></msub><mfrac><mrow><mi>N</mi></mrow><mrow><mi>d</mi><msub><mi>f</mi><mi>t</mi></msub></mrow></mfrac></mrow><annotation encoding="application/x-tex">
tf-idf_{t,d} = ( \frac{tf_{t,d}}{N}) \cdot \log_{10}  \frac{N}{df_t}
