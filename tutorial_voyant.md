...
<p>Ahora, más veces que no, la información más interesante no se encuentra dentro de las palabras más frecuentes, pues éstas tienden a ser también las más evidentes. Es por eso que en el campo de la recuperación de la información se han inventado otras medidas que permiten ubicar los términos que hacen que un documento se distinga de otro. Una de las medidas más usadas se llama tf-idf (term frequency, inverse document frequency); es decir, la frecuencia de un término es medida de acuerdo con qu</p>
<p>Y en Voyant se calcula <a href="https://twitter.com/VoyantTools/status/1025458748574326784">de la siguiente manera</a>:</p>
...
<strong>Palabras diferenciadas</strong>  (comparado con el resto del corpus):</p>
<ol>
